...
def build_capability_matrix() -> tuple[CapabilityMatrixEntry, ...]:
    rows = (
        ...
        ("Coding Specialist / CodingAgent Foundation", "Phase 28", "available_preview_only", "preview/report/status only", False, False, "not applicable", "cannot unlock execution", "Real source editing, patch application, shell/test/package/git execution, arbitrary file access, and tools remain locked.", "Review the preview, then continue to Phase 29 Public Demo / Release."),
        ("Public Demo / Release", "Phase 29", "available_status_only", "report/status/profile only", False, False, "not applicable", "cannot publish or commit", "No publishing, upload, package release, git release operation, external send, or unsafe execution.", "Release Candidate Hardening / optional user-approved commit planning."),
